...
export const projectList:Partial<Project>[] = [
    {
        ...
        featureDescription:"這是一個可以讓使用者快速線上簽署文件的網站 : \n- 使用者可使用繪圖板進行簽名\n- 可將簽名及上傳文件合併\n- 可儲存、查看歷史文件\n- 支援深色模式",
        technologyDescription:"- 圖片合併與拖拉縮放插件: fabric.js\n- PDF傳輸插件:react-pdf",
        futureDescription:"- 導入會員登入機制\n- 修復手機版本canvas顯示問題"
    },
    {
        id:crypto.randomUUID(),
        title:"自製元件集成網",
        ...
        featureDescription:"閒暇之餘的個人元件練功房，展示各種自製元件樣式，\n例如:btn、card、checkbox、knob...等，內容持續擴展中，不定期更新!",
    ...
    },
    {
        ...
        featureDescription:"一個串接全台灣旅遊資料而成的大冒險旅遊網站 : \n- 地理位置定位功能: 查詢使用者周邊資料\n- 大冒險 : 隨機推薦旅遊資訊\n- 我的收藏: 使用LocalStorage儲存使用者收藏\n- RWD響應式設計\n- 資料呈現 : 瀑布式載入",
        technologyDescription:"-API串接來源 : 交通部TDC 運輸資料流通服務\n- 專案UI框架 : Bootstrap5、SCSS \n- 地圖資訊顯示插件 : Vue3-OpenLayers Map\n- 動畫插件 : Gsap.js\n- 臺灣地圖視覺化呈現 : D3.js",
        futureDescription:"- 增加規劃行程功能"
    },
    {
        id:crypto.randomUUID(),
        title:"公車任意門",
        ...
        featureDescription:"串接全台灣公車資訊的公車查詢網站 :  \n- 查詢全台'公車動態'\n- 查詢全台'公車站點'\n- 查詢全台'公車票價'\n- 查詢使用者'附近站牌'\n- RWD響應式設計",
        technologyDescription:"-API串接來源 : 交通部TDC 運輸資料流通服務\n- 專案UI框架 : Bootstrap5、SCSS \n- 地圖資訊顯示插件 : Vue3-OpenLayers Map\n- 動畫插件 : Gsap.js\n- 臺灣地圖視覺化呈現 : D3.js",
        futureDescription:""
    },
    {
        ...
        featureDescription:"想做一個給小孩玩的'益智遊戲'平台，其中也包含了一些突發奇想的小遊戲實作。\n專案有遊戲難度的設計、遊戲音效等等。目前可玩遊戲: \n - 記憶翻翻牌\n - 八皇后棋局",
        technologyDescription:"- 目前專案中的特效皆純CSS製作",
        futureDescription:"- 導入會員登入機制\n- 遊戲商城功能\n- 增加怪獸棋遊戲"
    },
    {
        id:crypto.randomUUID(),
        ...
        featureDescription:"由洪夢澤(前端)與林鶴年(後端)共同開發的社群網站\n透過我們的網站，開發者可以上傳自己的產品已獲得即時的交流回饋 : \n- 使用者上傳功能 : 專案文案、圖片、影音等\n- 討論區功能 \n- RWD響應式設計 \n- 瀑布式資料載入",
        technologyDescription:"- 文字編輯套件 : vue-markdown + vue-quill-editor \n- Slider套件 : vue-easy-slider \n",
        futureDescription:"自己重刻後端部分，讓網站復活"
    },
    {
        id:crypto.randomUUID(),
        ...
        featureDescription:"由洪夢澤與林于騰使用java共同開發的遊戲，\n融合了塔防、自走棋、即時戰略等元素，開發獨創玩法\n遊戲中玩家可以自行擺陣，並於場中使用戰術指令左右戰局\n**遊戲中素材、遊戲場景由洪夢澤使用Blender3D建模軟體製作",
        technologyDescription:"- 使用Java製作",
        futureDescription:"- 遊戲能打包exe檔案"
    }
] 